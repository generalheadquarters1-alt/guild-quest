...
const ACTION_SENTENCE: Record<QuestLogAction, string> = {
  created: "を掲示しました。",
  accepted: "に参加しました。",
  quest_accepted_task_assigned: "を手帳に記しました。",
  succession_requested: "の助っ人を募集しました。",
  successor_added: "に助っ人参加しました。",
  completed: "を達成しました。",
  quest_completed_task_completed: "を討伐完了しました。",
  edited: "を書き換えました。",
  deleted: "を記録から外しました。",
  reopened: "を再掲しました。",
  expedition_started: "へ出発しました。",
  expedition_claimed: "から帰還しました。",
  expedition_success: "の遠征に成功しました。",
  expedition_failure: "の遠征に失敗しました。",
  ...
  train_proficiency: "を行いました。",
  rest_tavern: "を行いました。",
  guild_meeting: "に参加しました。",
  maintain_equipment: "を行いました。",
